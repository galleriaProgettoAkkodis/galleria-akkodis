		...
		return new WebMvcConfigurer() {
			...
			public void addCorsMappings(CorsRegistry registry) {
				registry.addMapping("/**") // abilito tutti gli url
						...
						.allowedMethods("PUT", "POST", "DELETE", "GET", "OPTION", "HEAD", "PATCH") //abilito tutti i metodi
						.allowedHeaders("*") // abilito tutti gli headers
						.exposedHeaders("header1", "header2", "Authorization").allowCredentials(false); // disabilito le
																										// credenziali
			}
		};
	}
